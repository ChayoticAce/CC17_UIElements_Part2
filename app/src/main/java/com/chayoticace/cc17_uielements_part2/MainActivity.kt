...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Add the songs
        songsArray.addAll(resources.getStringArray(R.array.gorillaz))
        songsArray.addAll(resources.getStringArray(R.array.kendrick))
        songsArray.addAll(resources.getStringArray(R.array.prototype))
